...
class RobotDataset(Dataset):
    ...
    def _generate_synthetic_data(self, num_samples):
        ...
        contact_possible = (self.current_suction_onoff == 1.0).squeeze(1)
        self.current_suction_contact[contact_possible, 0] = torch.randint(0, 2, (contact_possible.sum().item(),)).float()
...
class RobotTrainer:
    """Training manager for the robot control network (without TensorBoard)."""
    ...
    def train_epoch(self):
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            self.logger.add_scalar('train/joint_loss', joint_loss.item(), global_step)
            self.logger.add_scalar('train/suction_onoff_loss', suction_onoff_loss.item(), global_step)
...
def main():
    ...
    print("=" * 50)
    print("Robot Control Network Training (No TensorBoard)")
    print("=" * 50)
