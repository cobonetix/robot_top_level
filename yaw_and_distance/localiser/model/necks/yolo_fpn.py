...
class FPN_YOLOV3(nn.Module):
    ...
    def forward(self, x0, x1, x2):  # large, medium, small
        #print('Input to FPN. : ',x0.shape, x1.shape, x2.shape)
        # large
        ...
        #print('4. : ', r2.shape)
        #print('Inside FPN forward(): before error: ', x2.shape, r2.shape)
        x2 = self.__route1(x2, r2)
        r2 = self.__conv_set_2(x2)
        out2 = self.__conv2_0(r2)
        out2 = self.__conv2_1(out2)

        #print('Output of FPN:', out2.shape, out1.shape, out0.shape)
