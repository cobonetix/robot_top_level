...
# Initialize Localizer block
model_filename = 'localizer'
# Please note that you may need to change model_filename based on the model you are using
modelFilepath = "./6812074e3763fc3a47d42091.tar.crypt"
...
def decodeShelfNav():
                ...
                if len(label_centers) >= 2:
                    ...
                    # Draw the fitted line for the top row
                    ...
                    print(f"  Top row: slope={slope:.6f}  left_y={y_left}  right_y={y_right}")
                    print(f"  Angle to horizontal: {angle_deg:.4f} deg  (0 = aligned with shelf)")

                    cv2.putText(label_image, f"Top row labels: {len(top_row)}", (10, 30),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
                    cv2.putText(label_image, f"Angle: {angle_deg:.4f} deg", (10, 60),
